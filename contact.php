...
<head>
    ...
    <title>
        Cikwo : Informasi Untuk Pemesanan
    </title>
                    ...
                    <div class="box" id="contact">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <p><strong>+6285158799719</strong>
                                </p>
                            </div>
                            <!-- /.col-sm-4 -->
                            <div class="col-sm-4">
                                <h3><i class="fa fa-instagram"></i>Follow </i></h3>
                                <p class="text-muted">Untuk Mendapatkan Informasi Update Follow Instagram Cikwo Coffee</p>
                                <ul>
                                    <li><strong><a href="mailto:"> https://www.instagram.com/cikwo.coffee.liwa/?hl=id</a></strong>
                                    </li>
                                </ul>
                            </div>
                            <!-- /.col-sm-4 -->
